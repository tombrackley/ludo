    ...
    return (
        <section className="bg-background @container py-24">
            ...
            <div className="mx-auto w-full max-w-[1200px] px-6">
                <div className="@xl:grid-cols-2 @4xl:grid-cols-3 grid gap-3">
                    ...
                    <Card className="@xl:col-span-2 grid grid-rows-[1fr_auto] gap-8 rounded-2xl p-8 [--color-background:var(--color-muted)]">
                        <div className="relative flex flex-col items-center justify-center">
                            <div className="absolute inset-0 bg-[radial-gradient(var(--color-foreground)_1px,transparent_1px)] opacity-10 [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)]" />
                            ...
                            <div className="@lg:flex-row @4xl:aspect-auto flex aspect-video flex-col items-center gap-12">
                                <div className="relative">
                                    ...
                                    <ArrowBigRight
                                        strokeWidth={4}
                                        className="fill-illustration dark:fill-foreground/25 @lg:inset-y-0 @lg:right-0 @lg:my-auto @lg:translate-x-[150%] @lg:rotate-0 @xl:translate-y-0 absolute bottom-0 translate-x-[125%] translate-y-[200%] rotate-90 stroke-transparent drop-shadow"
                                    />
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <Equal
                                        strokeWidth={4}
                                        className="dark:fill-foreground/25 dark:stroke-foreground/25 fill-illustration stroke-illustration @lg:inset-x-auto @lg:inset-y-0 @lg:right-0 @lg:my-auto @lg:translate-x-[150%] @xl:translate-y-0 absolute inset-x-0 bottom-0 mx-auto translate-y-[150%] drop-shadow"
                                    />
                                </div>
                    ...
                    <div className="@xl:row-start-2 @4xl:row-start-auto @xl:space-y-0 @4xl:space-y-4 grid grid-rows-[1fr_auto] space-y-4">
                        ...
                        <Card className="@4xl:block @xl:hidden group space-y-4 overflow-hidden rounded-2xl p-8 text-center">
                            <span className="to-primary from-foreground block bg-gradient-to-r bg-clip-text text-5xl font-bold text-transparent">65%</span>
                            <div>
...
const SecurityShieldIsoIcon = () => {
    return (
        <svg
            ...
            className="text-foreground/15 fill-foreground/2 size-full">
            <path
