                ...
                <div className="mx-auto max-w-4xl">
                    ...
                    <div className="@lg:grid-cols-2 @lg:gap-y-12 mx-auto mt-10 grid max-w-2xl gap-3">
                        <div className="flex flex-col rounded-xl border bg-white p-6">
                            ...
                            <Button variant="outline" size="sm" className="mt-auto w-fit" render={<Link href="#link" />} nativeButton={false}>Schedule a call</Button>
                        </div>
                        <div className="flex flex-col rounded-xl border bg-white p-6">
                            ...
                            <div className="mt-auto flex flex-wrap gap-1">
                                <Button variant="outline" size="sm" className="w-fit" render={<Link href="#link" />} nativeButton={false}>Contact Support</Button>
                                <Button variant="ghost" size="sm" className="text-primary w-fit" render={<Link href="mailto:hello@ludo.computer" />} nativeButton={false}>hello@ludo.computer</Button>
                            </div>
                        </div>
