            ...
            <div className="mx-auto w-full max-w-5xl px-6 xl:px-0">
                <div className="@xl:grid-cols-2 grid gap-3">
                    <Card className="group grid grid-rows-[auto_1fr] gap-8 overflow-hidden rounded-2xl p-8">
                        ...
                        <div className="-mx-8 -mb-8 overflow-hidden flex items-end justify-center">
                            <img
                                src="/self-service-events.png"
                                alt="Self-service visitor app showing Fun Pass top-up"
                                className="w-[412px] max-w-full"
                            />
                        </div>
                    </Card>
                    <Card className="grid grid-rows-[auto_1fr] gap-8 overflow-hidden rounded-2xl p-8">
                        ...
                        <div className="-mx-8 -mb-8 overflow-hidden flex items-end">
                            <img
                                src="/pos-vendor-settlement.png"
                                alt="POS terminal with vendor transaction history"
                                className="w-full"
                            />
                        </div>
                    </Card>
