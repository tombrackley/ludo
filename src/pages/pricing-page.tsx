...
export default function PricingPage() {
    usePageMeta('Pricing — Ludo Leisure Suite', 'Contact us for pricing information on Ludo Leisure Suite for your venue or event.')
    return (
        <>
            <Header />
                    ...
                    <div className="@container mx-auto max-w-[1200px] px-2">
                        <div className="mx-auto max-w-4xl">
                            <div className="mx-auto max-w-2xl px-6">
                                <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:tracking-tight">Contact us for pricing information</h1>
                            ...
                            <div className="@lg:grid-cols-2 @lg:gap-y-12 mx-auto mt-10 grid max-w-2xl gap-3">
                                ...
                                <div className="flex flex-col p-6">
                                    ...
                                    <Link href="mailto:hello@ludo.computer" className="hover:decoration-primary font-medium hover:underline">hello@ludo.computer</Link>
                                </div>
                                <div className="flex flex-col p-6">
                                ...
                                <div className="flex flex-col p-6">
                                    ...
                                    <Link href="tel:1300669117" className="hover:decoration-primary font-medium hover:underline">1300 669 117</Link>
                                </div>
                                <div className="flex flex-col p-6">
                                    <h2 className="text-muted-foreground mb-2 text-sm">LinkedIn</h2>
                                    <Link href="https://www.linkedin.com/company/ludo-leisure-suite" className="hover:decoration-primary font-medium hover:underline">Ludo Leisure Suite</Link>
                                </div>
                            </div>
                        </div>
                    </div>
